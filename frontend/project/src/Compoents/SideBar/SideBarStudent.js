            ...
            <ul className="Links px-2 list-unstyled position-sticky">
                ...
                <li className="active">
                    <Link onClick={sideBarliToggle} className="link d-flex" to={'/stu'}>
                        <span className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill={Theme.sideBar} className="bi bi-book" viewBox="0 0 16 16">
                ...
                <li><Link onClick={sideBarliToggle} className="link  d-flex" to={'/stu/allcourses'}>
                    <span> <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fillRule="currentColor" className="bi bi-card-list" viewBox="0 0 16 16">
                        <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z" />
                        <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z" />
                    </svg></span><span className="sidebar-itme-text ms-2">Courses</span></Link></li>
                ...
                <li><Link onClick={sideBarliToggle} className="link d-flex" to={'/stu/library'}>
                    <span ><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fillRule="currentColor" className="bi bi-person-lines-fill-rule" viewBox="0 0 16 16">
                ...
                <li><Link onClick={sideBarliToggle} className="link d-flex" to={'/stu/chat'}>
                    <span ><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fillRule="currentColor" className="bi bi-chat-dots" viewBox="0 0 16 16">
                        <path d="M5 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
                        <path d="m2.165 15.803.02-.004c1.83-.363 2.948-.842 3.468-1.105A9.06 9.06 0 0 0 8 15c4.418 0 8-3.134 8-7s-3.582-7-8-7-8 3.134-8 7c0 1.76.743 3.37 1.97 4.6a10.437 10.437 0 0 1-.524 2.318l-.003.011a10.722 10.722 0 0 1-.244.637c-.079.186.074.394.273.362a21.673 21.673 0 0 0 .693-.125zm.8-3.108a1 1 0 0 0-.287-.801C1.618 10.83 1 9.468 1 8c0-3.192 3.004-6 7-6s7 2.808 7 6c0 3.193-3.004 6-7 6a8.06 8.06 0 0 1-2.088-.272 1 1 0 0 0-.711.074c-.387.196-1.24.57-2.634.893a10.97 10.97 0 0 0 .398-2z" />
                    </svg></span><span className="sidebar-itme-text ms-2">Chat</span></Link></li>


                <li><Link onClick={sideBarliToggle} className="link d-flex" to={'/stu/profile'}>
                    <span ><svg xmlns="http://wwwprofile.w3.org/2000/svg" width="17" height="17" fillRule="currentColor" className="bi bi-person-badge-fill-rule" viewBox="0 0 16 16">
                        <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm4.5 0a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3zM8 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm5 2.755C12.146 12.825 10.623 12 8 12s-4.146.826-5 1.755V14a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-.245z" />
                    </svg></span><span className="sidebar-itme-text ms-2">Profile</span></Link></li>

                <li><Link onClick={sideBarliToggle} className="link d-flex" to={'/stu/settings'}>
                    <span ><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fillRule="currentColor" className="bi bi-gear-fill-rule" viewBox="0 0 16 16">
                        <path d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z" />
                    </svg></span><span className="sidebar-itme-text ms-2">Settings</span></Link></li>
            </ul>
...
// this sidebar maychange .... like if i have alot of li li li li .... we put the last div inside the ul with no position sticky 