        ...
        <div className='index'>
            ...
            <section className='cources'>
                <div className='container'>
                    <div className='intro-text-section text-center mb-4'>
                        ...
                        <p className='w-75 mx-auto'>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a pi classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock,</p>
                    </div>
                    <div className='cources-cards d-flex flex-wrap justify-content-center gap-3'>
                        <div className='cource-card border border-1 px-3 py-4 bg-info text-center'>
                            <img src={logo1} className="" alt='icon' />
                            <h3 className='fs-4 fw-normal text-capitalize '>html & css</h3>
                        </div>
                        <div className='cource-card border border-1 px-3 py-4 bg-info text-center'>
                    ...
                    <div className='whyus-cards d-flex pt-5 justify-content-center gap-5 gap-md-0'>
                        <div class="card border-0  text-center bg-transparent">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Contrary to popular belief, Lorem Ipsum isnotimply random text. It has roots in a pi classiLatin litture from 45 BC,</p>
                            </div>
                        </div>
                        <div class="card border-0 text-center bg-transparent">
                            <img src={whyuslogo2} className="card-img-top mx-auto mb-3" alt="logo" />
                            <div class="card-body">
                                <h5 class="card-title">Superfast Support</h5>
                                <p class="card-text">Contrary to popular belief, Lorem Ipsum isnotimply random text. It has roots in a pi classiLatin litture from 45 BC,</p>
                            </div>
                        </div>
                        <div class="card border-0 text-center bg-transparent">
            ...
            <section className='Comments'>
                <div className='container text-center'>
                    ...
                    <p className="text-white w-75 mx-auto my-2 mb-3">There are many variations of passages of Lorem Ipsum typesetting industry has been the industry's standard dummy text ever since the been when an unknown printer.</p>
            ...
            <section className='popular-cources'>
                <div className='container'>
                    <div className='intro-text-section mb-4'>
                        ...
                        <p className='w-75 mx-auto text-center'>There are many variations of passages of Lorem Ipsum typesetting industry has been the industry's standard dummy text ever since the been when an unknown printer.</p>
